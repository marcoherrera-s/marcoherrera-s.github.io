...
![libroantes](/assets/otro/pdfantes.png)
...
![terminal](/assets/otro/image.png)
...
![device](/assets/otro/image-1.png)
...
![kindle](/assets/otro/image-2.png)
...
<div style="display: flex; align-items: flex-start;">
  <figure style="margin-right: 10px; text-align: center;">
    <img src="/assets/otro/pdfantes.png" alt="antes" style="width: 200px;">
    <figcaption>Antes</figcaption>
  </figure>
  <figure style="text-align: center;">
    <img src="/assets/otro/pdfdespues.png" alt="después" style="width: 200px;">
